...
- Companion mobile app — [Product Management App](../product-management-app) (React Native / Expo / EAS) for remote store management from anywhere
...
Raw diagram source: [`architecture/architecture.mmd`](architecture/architecture.mmd)
...
- *[Add your business numbers here — e.g. monthly orders, indexed pages, organic traffic growth]*
...
- [Product Management App](../product-management-app) — React Native / Expo / EAS companion app for managing this store remotely
- [Nik Wear Portfolio](../nik-wear-portfolio) — custom WooCommerce e-commerce website & theme
